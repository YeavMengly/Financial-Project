...
<head>
    ...
    <meta charset="utf-8" />
  <title>Maintenance | {{ __("labels.mlvt") }}</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <div class="mb-5">
                                <a href="index.html">
                                    <img src="assets/images/logo-sm.svg" alt="" height="30"
                                        class="me-1"><span
                                        class="logo-txt text-dark font-size-22">{{ __('labels.mlvt') }}</span>
                                </a>
                            </div>
                            ...
                            <h3 class="mt-4">គេហទំព័រកំពុងស្ថិតក្នុងការថែទាំប្រព័ន្ធ</h3>
                            <p>សូមត្រលប់មកម្តងទៀតនៅពេលក្រោយ។</p>
