                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="save">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <a download href="{{ asset($this->documentOldFile) }}"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">
                                        {{ __('forms.document.file') }}
                                    </label>

                                    <input type="file" class="form-control" wire:model="documentFile" />
