...
class paymentDeadlineTraining extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.budgetPlan.paymentDeadlineTrainingFile');
    }
    ...
    public function save()
    {
        ...
        $path_store = "uploads/budgetPlan/paymentDeadlineTraining/" . date("Y-m-d");
        // delete old file
        ...
        try {
            ...
            return redirect()->route('budgetTraining.paymentDeadline.index', [
                'params' => $this->params
            ]);
        } catch (\Exception $e) {
            DB::rollBack();
