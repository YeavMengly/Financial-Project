...
class ExpenseRecordTrainingFile extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.budgetPlan.expenseRecordTraining');
    }
    ...
    public function save()
    {
        ...
        $path_store = "uploads/budgetPlan/expenseRecordTraining/" . date("Y-m-d");
        // delete old file
        ...
        try {
            ...
            return redirect()->route('budgetTraining.expenseRecord.index', [
                'params' => $this->params
            ]);
        } catch (\Exception $e) {
            DB::rollBack();
