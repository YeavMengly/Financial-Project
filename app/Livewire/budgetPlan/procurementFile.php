...
class ProcurementFile extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.budgetPlan.procurement');
    }
    ...
    public function save()
    {
        ...
        $path_store = "uploads/budgetPlan/procurement/" . date("Y-m-d");
        // delete old file
        ...
        try {
            ...
            return redirect()->route('budgetProcurement.index', [
                'params' => $this->params
            ]);
        } catch (\Exception $e) {
            DB::rollBack();
