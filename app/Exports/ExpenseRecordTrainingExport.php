...
class ExpenseRecordTrainingExport
{
    protected $data;
    ...
    public function export(Request $request)
    {
        ...
        $templatePath = storage_path('excel/template/template_expense_record_book_training.xlsx');
        ...
        $fileName = 'template_expense_record_book_training.xlsx';
