...
class InitialDeadlineTrainingDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('budgetplan::initialTraining.paymentDeadline.action', ['module' => $model]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialDeadlineTraining-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialDeadlineTraining-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialDeadlineTraining_' . date('YmdHis');
    }
}
