...
use App\Models\InitialPaymentDeadline;
...
class InitialPaymentDeadlineDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('budgetplan::initialDirectPayment.paymentDeadline.action', ['module' => $model]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialpaymentDeadline-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialpaymentDeadline-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialPaymentDeadline_' . date('YmdHis');
    }
}
