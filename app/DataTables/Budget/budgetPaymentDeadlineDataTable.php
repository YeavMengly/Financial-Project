...
use App\Models\budgetPaymentDeadline;
...
class budgetPaymentDeadlineDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('budgetplan::budgetDirectPayment.paymentDeadline.action', ['module' => $module]);
            })
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->setTableId('budgetpaymentdeadline-table')
    ...
    {
        return 'budgetPaymentDeadline_' . date('YmdHis');
    }
}
