...
class BudgetTrainingDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('budgetplan::budgetTraining.expenseRecord.action', ['module' => $module]);
            })
    ...
    public function query(BudgetMandate $model, Request $request): QueryBuilder
    {
        ...
        if ($request->cboTodo) {
            if ($request->cboTodo == 2) {
                ...
                $model->where('budget_mandates.expense_type_id', 8);
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->setTableId('budgettraining-table')
    ...
    {
        return 'BudgetTraining_' . date('YmdHis');
    }
}
