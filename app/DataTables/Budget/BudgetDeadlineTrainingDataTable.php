...
class budgetDeadlineTrainingDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('budgetplan::budgetTraining.paymentDeadline.action', ['module' => $module]);
            })
    ...
    public function query(BudgetVoucher $model, Request $request): QueryBuilder
    {
        ...
        $model->where('budget_vouchers.expense_type_id', 8);
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->setTableId('budgetdeadlineTraining-table')
    ...
    {
        return 'BudgetDeadlineTraining_' . date('YmdHis');
    }
}
