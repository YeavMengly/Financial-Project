...
use App\Models\InitialRoyaltyVoucher;
use Carbon\Carbon;
...
class InitialRoyaltyVoucherDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('budgetplan::royalty.initialroyaltyvoucher.action', ['module' => $model]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialroyaltyvoucher-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialroyaltyvoucher-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialRoyaltyVoucher_' . date('YmdHis');
    }
}
