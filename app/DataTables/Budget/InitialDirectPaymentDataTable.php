...
use App\Models\InitialDirectPayment;
use Carbon\Carbon;
...
class InitialDirectPaymentDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
         return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('budgetplan::initialDirectPayment.expenseRecord.action', ['module' => $model]);
            })
    ...
    {
       return $this->builder()
            ->setTableId('initialdirectpayment-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialdirectpayment-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialDirectPayment_' . date('YmdHis');
    }
}
