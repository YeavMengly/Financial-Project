...
use App\Models\InitialRoyaltyMandate;
use Carbon\Carbon;
...
class InitialRoyaltyMandateDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('budgetplan::royalty.initialRoyaltyMandate.action', ['module' => $model]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialroyaltymandate-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialroyaltymandate-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialRoyaltyMandate_' . date('YmdHis');
    }
}
