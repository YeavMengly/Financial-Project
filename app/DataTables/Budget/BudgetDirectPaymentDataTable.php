...
class BudgetDirectPaymentDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
       return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('budgetplan::budgetDirectPayment.expenseRecord.action', ['module' => $module]);
            })
       ...
       return $this->builder()
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#budgetdirectpayment-table").DataTable().ajax.reload();
                });
            }')
            ->setTableId('budgetdirectpayment-table')
    ...
    {
        return 'BudgetDirectPayment_' . date('YmdHis');
    }
}
