...
use App\Models\InitialAdvancePayment;
use Carbon\Carbon;
...
class InitialAdvancePaymentDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('budgetplan::initialAdvancePayment.action', ['module' => $model]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialadvancepayment-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialadvancepayment-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialAdvancePayment_' . date('YmdHis');
    }
}
