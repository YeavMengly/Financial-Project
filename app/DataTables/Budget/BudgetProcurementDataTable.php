...
use App\Models\BudgetProcurement;
use Carbon\Carbon;
...
class BudgetProcurementDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('budgetplan::budgetProcurement.action', ['module' => $module]);
            })
    ...
    public function query(BudgetMandate $model, Request $request): QueryBuilder
    {
        ...
        if ($request->cboTodo) {
            if ($request->cboTodo == 2) {
                ...
                $model->where('budget_mandates.expense_type_id', 4);
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->setTableId('budgetprocurement-table')
    ...
    {
        return 'BudgetProcurement_' . date('YmdHis');
    }
}
