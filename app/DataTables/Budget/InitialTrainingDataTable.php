...
class InitialTrainingDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
         return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('budgetplan::initialTraining.expenseRecord.action', ['module' => $model]);
            })
    ...
    {
       return $this->builder()
            ->setTableId('initialTraining-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialTraining-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialTraining_' . date('YmdHis');
    }
}
