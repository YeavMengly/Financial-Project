...
use App\Models\InitialProcurement;
...
class InitialProcurementDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('budgetplan::initialProcurement.action', ['module' => $model]);
            })
     ...
     */
    // public function query(InitialProcurement $model): QueryBuilder
    // {
    ...
    public function html(): HtmlBuilder
    {
        ...
        return $this->builder()
            ->setTableId('initialprocurement-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialprocurement-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialProcurement_' . date('YmdHis');
    }
}
