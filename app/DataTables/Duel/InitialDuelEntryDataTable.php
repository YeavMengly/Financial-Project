...
use Carbon\Carbon;
use App\Models\InitialDuelEntry;
...
class InitialDuelEntryDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('duel::duelEntry.initialDuelEntry.action', ['module' => $model]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialduelentry-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialduelentry-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialDuelEntry_' . date('YmdHis');
    }
}
