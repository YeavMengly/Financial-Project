...
class InitialProjectsDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('material::project.initialProject.action', ['module' => $model]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialprojects-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialprojects-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialProjects_' . date('YmdHis');
    }
}
