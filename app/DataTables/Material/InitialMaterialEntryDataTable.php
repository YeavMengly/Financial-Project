...
class InitialMaterialEntryDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('material::materialEntry.initialMaterialEntry.action', ['module' => $model]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialmaterialentry-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialmaterialentry-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialMaterialEntry_' . date('YmdHis');
    }
}
