...
class InitialWaterDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('water::water.initialWater.action', ['module' => $model]);
            })
    ...
    {
        return 'InitialWater_' . date('YmdHis');
    }
}
