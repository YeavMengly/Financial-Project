...
use App\Models\InitialWaterEntity;
use Carbon\Carbon;
...
class InitialWaterEntityDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('water::water.entity.initialWaterEntity.action', ['module' => $model]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialwaterentity-table')
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialwaterentity-table").DataTable().ajax.reload();
                });
            }')
            ->orderBy(2, 'ASC');
    }
    ...
    {
        return 'InitialWaterEntity_' . date('YmdHis');
    }
}
