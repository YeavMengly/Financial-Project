...
class ChapterNumberDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('chapternumber::action', ['module' => $module]);
            })
            // 
    ...
    public function query( $model): QueryBuilder
    {
        ...
        if (request()->filled('cbochapterNum')) {
            $query->where('chapterNumber', request('cbochapterNum'));
        }

        if (request()->filled('cboTxtChapter')) {
            $query->where('txtChapter', 'like', '%' . request('cboTxtChapter') . '%');
        }
    ...
    {
        // return $this->builder()
        //     ->setTableId('chapternumber-table')
    ...
    {
        return 'ChapterNumber_' . date('YmdHis');
    }
}
