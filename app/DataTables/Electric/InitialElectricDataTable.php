...
use App\Models\InitialElectric;
use Carbon\Carbon;
...
class InitialElectricDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('electric::electric.initialElectric.action', ['module' => $model]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialelectric-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialelectric-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialElectric_' . date('YmdHis');
    }
}
