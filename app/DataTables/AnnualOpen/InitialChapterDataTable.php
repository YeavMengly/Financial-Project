...
class InitialChapterDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('beginningcredit::initialChapter.action', ['module' => $module]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialchapter-table')
            ->parameters([
                'language' => [
    ...
    {
        return 'InitialChapter_' . date('YmdHis');
    }
}
