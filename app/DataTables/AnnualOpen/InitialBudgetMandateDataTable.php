...
class InitialBudgetMandateDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        //     ->addColumn('action', 'initialbudgetmandate.action')
        //     ->setRowId('id');
        return (new EloquentDataTable($query))
            ->addIndexColumn()
    ...
    {
        return $this->builder()
            ->setTableId('initialbudgetmandate-table')
            ->parameters([
                'language' => [
    ...
    {
        return 'InitialBudgetMandate_' . date('YmdHis');
    }
}
