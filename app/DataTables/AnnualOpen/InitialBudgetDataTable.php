...
class InitialBudgetDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($model) {
                return view('beginningcredit::initialBudget.action', ['module' => $model]);
            })
    ...
    public function query(InitialBudget $model): QueryBuilder
    {
        ...
        return $query->orderBy('initial_budgets.created_at', 'ASC');
    }
    ...
    {
        return $this->builder()
            ->setTableId('initialbudget-table')
            ->parameters([
                'language' => [
    ...
    {
        return 'InitialBudget_' . date('YmdHis');
    }
}
