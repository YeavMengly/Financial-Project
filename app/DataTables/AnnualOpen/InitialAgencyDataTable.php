...
class InitialAgencyDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('content::content.agency.initialAgency.action', ['module' => $module]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('initialagency-table')
            ->parameters([
                'language' => [
            ...
            ->initComplete('function () {
                $("#filter").submit(function(event) {
                    ...
                    $("#initialagency-table").DataTable().ajax.reload();
                });
            }')
    ...
    {
        return 'InitialAgency_' . date('YmdHis');
    }
}
