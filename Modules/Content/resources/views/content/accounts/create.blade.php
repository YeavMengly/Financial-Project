    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <h4 class="mb-sm-0 font-size-18">{{ __('menus.content.accounts') }}</h4>
                ...
                <div class="page-title-right">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('menus.content.accounts') }}</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <form id="pristine-valid-example" novalidate method="POST"
                        action="{{ route('accounts.store', ['params' => $params, 'chId' => $chId]) }}" autocomplete="off">
                        @csrf
                        <input type="hidden" />
                        <div class="row">
