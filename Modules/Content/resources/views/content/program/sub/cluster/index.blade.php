            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">{{ __('menus.content.cluster') }}</li>
                    </ol>
                </h4>
                ...
                <div class="page-title-right">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="javascript: void(0);"><span>{{ __('menus.content.program.sub') }}</span>
                                    <span>{{ $programSub->no }}</span></a>
                            </li>
                            <li class="breadcrumb-item active">{{ __('menus.content.cluster') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
