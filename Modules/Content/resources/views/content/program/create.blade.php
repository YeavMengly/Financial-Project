    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('menus.content.program') }}</h4>
                ...
                <div class="page-title-right">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('menus.content.program') }}</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea id="txtProgram" data-pristine-required-message="{{ __('messages.required') }}" rows="5"
                                        class="form-control" name="title" required></textarea>
                                    @error('title')
