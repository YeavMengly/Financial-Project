...
@section('css')
    ...
    <style>
        ...
        #costimplementchaptermandate-table {
            width: 100% !important;
            margin: 0 !important;
        ...
        #costimplementchaptermandate-table th,
        #costimplementchaptermandate-table td {
            ...
            <div class="card shadow-sm border-0">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <div class="d-flex align-items-center gap-2">
                           ...
                           <select id="yearFilter" name="yearFilter" class="form-select">
                            ...
                            @include('report::report.cost_implement.chapter.mandate.dropdown')
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-3">
                    <div class="table-responsive-wrapper">
                        <table id="costimplementchaptermandate-table" class="table table-bordered table-hover align-middle">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#costimplementchaptermandate-table').on('xhr.dt', function(e, settings, json) {
                ...
                setTimeout(function() {
                    $('#costimplementchaptermandate-table').DataTable().columns.adjust();
                }, 50);
            });
            ...
            $(document).on('change', '#yearFilter, #ministryFilter, select[name="ministry_id"], #ministry_id',
                function() {
                    $('#costimplementchaptermandate-table').DataTable().ajax.reload();
                });
            ...
            $(document).on('change', '.toggle-column-chapter', function() {
                const table = $('#costimplementchaptermandate-table').DataTable();
