...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form id="pristine-valid-example" novalidate method="POST" action="{{ route('document.store') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input data-pristine-required-message="{{ __('messages.required') }}"
                                        ...
                                        data-pristine-integer-message="ឆ្នាំ ត្រូវតែលេខ" min="1" type="integer"
                                        class="form-control" name="txtYear" required />
                                    @error('txtYear')
                                        <div class="pristine-error text-help">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    <label>{{ __('forms.document.file') }}</label>
                                    <input required data-pristine-required-message="ជ្រើសរើស ឯកសារសំរាប់រក្សាទុក!"
                                        type="file" class="form-control" name="documentFile" />
                                    @error('documentFile')
                                        <div class="pristine-error text-help">{{ $message }}</div>
                                    @enderror
                                </div>
