    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <form id="pristine-valid-example" action="{{ route('voucher.update', $params) }}" method="POST"
                                        ...
                                        <select class="form-control" id="cboSubAccountNumber" name="subAccountNumber"
                                            ...
                                            @foreach ($beginCredit as $bc)
                                                <option value="{{ $bc->subAccountNumber }}"
                                                    ...
                                                    {{ old('subAccountNumber', $voucher->subAccountNumber == $bc->subAccountNumber ? 'selected' : ' ') }}>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" min="0" name="program" id="programInput" readonly
                                            required class="form-control" value="{{ old('program', $voucher->program) }}"
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" min="0" name="internal_increase" id="internal_increase"
                                            class="form-control"
                                            value="{{ old('internal_increase', $voucher->internal_increase) }}"
                                            data-pristine-required-message="{{ __('messages.required') }}" />
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" min="0" name="unexpected_increase"
                                            ...
                                            value="{{ old('unexpected_increase', $voucher->unexpected_increase) }}"
                                            data-pristine-required-message="{{ __('messages.required') }}" />
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" min="0" name="additional_increase"
                                            ...
                                            value="{{ old('additional_increase', $voucher->additional_increase) }}"
                                            data-pristine-required-message="{{ __('messages.required') }}" />
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" min="0" name="decrease" id="decrease"
                                            class="form-control" value="{{ old('decrease', $voucher->decrease) }}"
                                            data-pristine-required-message="{{ __('messages.required') }}" />
                                        @error('decrease')
                                            <div class="pristine-error text-help">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" min="0" name="editorial" id="editorial"
                                            class="form-control" value="{{ old('editorial', $voucher->editorial) }}"
                                            data-pristine-required-message="{{ __('messages.required') }}" />
                                        @error('editorial')
                                            <div class="pristine-error text-help">{{ $message }}</div>
                                        @enderror
