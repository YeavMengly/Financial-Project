                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="stock_number" required class="form-control"
                                            tabindex="1" data-pristine-required-message="{{ __('messages.required') }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="stock_name" required class="form-control" tabindex="2"
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="user_entry" required class="form-control" tabindex="5"
                                            data-pristine-required-message="{{ __('messages.required') }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="user_receiver" required class="form-control"
                                            tabindex="6"
                                            data-pristine-required-message="{{ __('messages.required') }}" />
                                    </div>
                                </div>
...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Re-initialize Pristine so it reads updated HTML attributes (required/not required)
            function refreshPristine() {
                if (pristine) {
                    pristine.destroy();
                }
            ...
            // Initial Pristine load
            refreshPristine();

            // Toggle Handler
            const setupSkipToggle = (checkboxId, inputId, defaultValue = '', isFile = false) => {
                ...
                checkbox.addEventListener('change', function() {
                    if (this.checked) {
                        // SKIP ON: Reset file/value, disable input, and set green style
                        if (isFile) {
                            input.value = ''; // Completely removes selected files
                        } else {
                            input.value = defaultValue;
                        }

                        input.disabled = true; // Prevents selection & excludes from form submission
                        ...
                        // SKIP OFF: Re-enable input and restore validation
                        input.value = '';
                        ...
                        // Restore validation attribute
                        input.setAttribute('required', 'true');
                        input.setAttribute('data-pristine-required-message', origRequiredMsg);
                    }

                    // Refresh Pristine rules after state change
                    refreshPristine();
                });
            };

            // Initialize switches
            // param 1: checkbox ID, param 2: input ID, param 3: default value, param 4: is it a file input?
            setupSkipToggle('skipFileInput', 'fileInput', '', true);
            setupSkipToggle('skipTitleInput', 'titleInput', '', false);

            // Form Submission Handler
            form.addEventListener('submit', function(e) {
                // Since disabled inputs are ignored by Pristine, it will validate successfully when skipped
