...
use Modules\BeginningCredit\App\Http\Controllers\InitialAccountController;
...
Route::middleware('PermissionCheck')->controller(InitialAccountController::class)->group(function () {
    Route::get('initial-account/', 'index')->name('initialAccount.index'); // GET: initial-budget/
});
