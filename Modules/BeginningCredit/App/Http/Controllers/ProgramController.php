...
class ProgramController extends Controller
{
    ...
    public function index(ProgramDataTable $dataTable, $params)
    {
        ...
        return $dataTable->render('beginningcredit::programs.index', [
            'params' => $params,
            'data' => $data,
    ...
    {
        return view('beginningcredit::programs.create')
            ->with('params', $params);
    }
    ...
    public function store(Request $request, $params)
    {
        ...
        try {
            ...
            return redirect()->route('programs.index', $params);
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function edit($params)
    {
        ...
        return view('beginningcredit::programs.edit')
            ->with('data', $data)
            ->with('params', $params);
    }
    ...
    public function update(Request $request, $params)
    {
        ...
        return redirect()->route('programs.index', encode_params($program->ministry_id));
    }
