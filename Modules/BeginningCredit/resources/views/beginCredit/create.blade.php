    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('menus.cluster') }} @foreach ($initialBudget as $item)
                        {{ $item->year }}
                    @endforeach
                </h4>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <form id="pristine-valid-example" action="{{ route('beginCredit.store', encode_params($params)) }}"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control" data-trigger id="cboSubAccountNumber"
                                            ...
                                            @foreach ($subAccount as $subAcc)
                                                <option value="{{ $subAcc->subAccountNumber }}">
                                                    {{ $subAcc->subAccountNumber }}</option>
                                            @endforeach
                                        </select>
