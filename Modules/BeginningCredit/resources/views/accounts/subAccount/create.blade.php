...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form id="pristine-valid-example" novalidate method="POST" action="{{ route('subAccount.store') }}"
                        autocomplete="off">
                        @csrf
                        <input type="hidden" />
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input required data-pristine-required-message="{{ __('messages.required') }}"
                                        type="text" class="form-control" name="subAccountNumber" tabindex="2" />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input required data-pristine-required-message="{{ __('messages.required') }}"
                                        type="text" class="form-control" name="txtSubAccount" tabindex="3" />
                                    @error('txtSubAccount')
                                        <div class="pristine-error text-help">{{ $message }}</div>
                                    @enderror
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const accountChoices = new Choices(accountElement, {
                ...
                searchPlaceholderValue: 'ស្វែងរកលេខគណនី...',
                shouldSort: false
            });
        });
    </script>
