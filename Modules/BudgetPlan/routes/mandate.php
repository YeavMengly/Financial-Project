...
Route::middleware('PermissionCheck')
    ...
    ->group(function () {
        ...
        Route::get('royalty-mandate', 'getIndexRoyaltyMandate')->name('initialRoyaltyMandate.index');
        Route::get('royalty-mandate/{params}', 'indexRoyaltyMandate')->name('royaltyMandate.index');
        Route::get('royalty-mandate/{params}/create', 'createRoyaltyMandate')->name('royaltyMandate.create');
        Route::get('royalty-mandate/{params}/edit/{id}', 'editRoyaltyMandate')->name('royaltyMandate.edit');
        Route::get('royalty-mandate/{params}/destroy/{id}', 'destroyRoyaltyMandate')->name('royaltyMandate.destroy');

        // Route::get('royalty/', 'getIndexRoyaltyVoucher')->name('initialRoyaltyVoucher.index');
        // Route::get('royalty/{params}', 'indexRoyaltyVoucher')->name('budgetRoyaltyVoucher.index');
        // Route::get('royalty/{params}/create', 'createRoyaltyVoucher')->name('budgetRoyaltyVoucher.create');
        // Route::get('royalty/{params}/edit/{id}', 'editRoyaltyVoucher')->name('budgetRoyaltyVoucher.edit');
        // Route::get('royalty/{params}/destroy/{id}', 'destroyRoyaltyVoucher')->name('budgetRoyaltyVoucher.destroy');
    });
...
Route::controller(BudgetMandateController::class)->group(function () {
    ...
    Route::get('royalty/mandate/{params}/exportRoyaltymandate', 'exportRoyaltyMandate')->name('royaltyMandate.exportRoyaltyMandate');
...
>>>>>>> dd0ac3c454ec48c2102dda64f4f4723744f8704c
    ...
    Route::get('royalty-mandate/get-by-program/program-subs', 'getByProgramId')->name('royaltyMandate.by.program_sub');
    Route::get('royalty-mandate/get-by-program/agencies', 'getByAgency')->name('royaltyMandate.by.agency');
    Route::get('royalty-mandate/get-by-program-sub/clusters', 'getByProgramSubId')->name('royaltyMandate.by.cluster');
    // These routes are for edit page ajax request
    Route::get('royalty-mandate/edit-by-program/program-subs', 'editByProgramId')->name('royaltyMandate.edit.program_sub');
    Route::get('royalty-mandate/edit-by-program/agencies', 'editByAgency')->name('royaltyMandate.edit.agency');
    Route::get('royalty-mandate/edit-by-program-sub/clusters', 'editByProgramSubId')->name('royaltyMandate.edit.cluster');

    Route::get('royalty-mandate/{params}/get-early-balance', 'getEarlyBalance')
