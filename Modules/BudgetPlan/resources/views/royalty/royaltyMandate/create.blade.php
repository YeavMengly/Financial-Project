                ...
                <div class="card-body">
                    <div>
                        <form id="pristine-valid-example"
                            action="{{ route('royaltyMandate.store', $params) }}" method="POST"
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <a class="btn btn-dark"
                                    href="{{ route('royaltyMandate.index', $params) }}">{{ __('buttons.back') }}</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#cboProgram').on('change', function() {
                ...
                loadOptions({
                    url: "{{ route('royaltyMandate.by.program_sub') }}",
                    data: {
                ...
                loadOptions({
                    url: "{{ route('royaltyMandate.by.agency') }}",
                    data: {
                        program_id: programId
                    },
            ...
            $('#cboProgramSub').on('change', function() {
                ...
                loadOptions({
                    url: "{{ route('royaltyMandate.by.cluster') }}",
                    data: {
            ...
            const fetchEarlyBalance = async () => {
                ...
                const url = new URL(
                    "{{ route('royaltyMandate.getEarlyBalance', ['params' => $params]) }}",
