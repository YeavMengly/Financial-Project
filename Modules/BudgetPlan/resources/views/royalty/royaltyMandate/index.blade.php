...
@section('content')
                ...
                <div class="page-title-right">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{ __('menus.expense.record.book') }}</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <form class="row gx-3 gy-2 align-items-center mb-4 mb-lg-0" id="filter" method="GET">
                        ...
                        <div class="col-sm-3 d-flex align-items-center gap-2">
                            ...
                            <a id="btnExport"
                                href="{{ route(
                                    'royaltyMandate.exportRoyaltyMandate',
                                    array_merge(
                                        ['params' => $params],
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @if (hasPermission('royaltyMandate.create'))
                        <div class="col-sm">
                            <div class="mb-4">
                                <a class="btn btn-light waves-effect waves-light"
                                    href="{{ route('royaltyMandate.create', $params) }}"><i class="bx bx-plus me-1"></i>
                                    {{ __('buttons.create') }}</a>
                            </div>
                        </div>
                    @endif
...
@section('script')
    ...
    <script>
        $('#btnExport').on('click', function(e) {
            ...
            let baseUrl = "{{ route('royaltyMandate.exportRoyaltyMandate', ['params' => $params]) }}";
