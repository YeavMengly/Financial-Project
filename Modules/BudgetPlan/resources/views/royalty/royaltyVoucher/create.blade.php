    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <form id="pristine-valid-example" action="{{ route('royaltyVoucher.store', $params) }}"
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <a class="btn btn-dark"
                                    href="{{ route('royaltyVoucher.index', $params) }}">{{ __('buttons.back') }}</a>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $(document).ready(function() {
                ...
                $('#cboExpenseType').on('change', function(e, preSelectedLegalId = null) {
                    ...
                    $.ajax({
                        url: "{{ route('royaltyVoucher.get.expense_type_id') }}",
                        type: 'GET',
                        data: {
                            expense_type_id: expenseTypeId,
            ...
            $('#cboProgram').on('change', function() {
                ...
                loadOptions({
                    url: "{{ route('royaltyVoucher.by.program_sub') }}",
                    data: {
                ...
                loadOptions({
                    url: "{{ route('royaltyVoucher.by.agency') }}",
                    data: {
                        program_id: programId
                    },
            ...
            $('#cboProgramSub').on('change', function() {
                ...
                loadOptions({
                    url: "{{ route('royaltyVoucher.by.cluster') }}",
                    data: {
            ...
            const fetchEarlyBalance = async () => {
                ...
                const url = new URL(
                    "{{ route('royaltyVoucher.getEarlyBalance', ['params' => $params]) }}",
