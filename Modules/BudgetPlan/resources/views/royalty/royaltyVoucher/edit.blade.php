            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">{{ __('menus.royalty') }}</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="pristine-valid-example"
                        action="{{ route('royaltyVoucher.update', ['params' => $params, 'id' => $module->id]) }}"
...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const ENDPOINT =
                "{{ route('royaltyVoucher.editEarlyBalance', ['params' => $params]) }}";
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleProgramChangeForProgramSub(programId, selectedId = null) {
                ...
                loadOptions({
                    url: "{{ route('royaltyVoucher.edit.program_sub') }}",
                    data: {
            ...
            function handleProgramChangeForAgency(programId, selectedId = null) {
                ...
                loadOptions({
                    url: "{{ route('royaltyVoucher.edit.agency') }}",
                    data: {
                        program_id: programId,
                        selected_id: selectedId
                    },
            ...
            function handleProgramSubChangeForCluster(programSubId, selectedId = null) {
                ...
                loadOptions({
                    url: "{{ route('royaltyVoucher.edit.cluster') }}",
                    data: {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadLegalId(expenseTypeId, selectedId = null) {
                ...
                $.ajax({
                    url: "{{ route('royaltyVoucher.edit.expense_type_id') }}",
                    type: "GET",
                    data: {
                        expense_type_id: expenseTypeId,
                        selected_id: selectedId
