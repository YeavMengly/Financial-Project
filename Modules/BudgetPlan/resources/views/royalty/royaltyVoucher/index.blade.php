...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18"> {{ __('menus.royalty') }}</h4>
                <div class="page-title-right">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{ $data->year }}</a>
                            </li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('menus.pre.financing') }}</a>
                            </li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('menus.royalty') }}</a>
                            </li>

                            <li class="breadcrumb-item active">{{ __('menus.payment.deadline') }}</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <form class="row gx-3 gy-2 align-items-center mb-4 mb-lg-0" id="filter" method="GET">
                        ...
                        <div class="col-sm-3 d-flex align-items-center gap-2">
                            ...
                            <a id="btnExport"
                                href="{{ route(
                                    'royaltyVoucher.exportRoyaltyVoucher',
                                    array_merge(
                                        ['params' => $params],
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @if (hasPermission('royaltyVoucher.create'))
                        <div class="col-sm">
                            <div class="mb-4">
                                <a class="btn btn-light waves-effect waves-light"
                                    href="{{ route('royaltyVoucher.create', $params) }}"><i class="bx bx-plus me-1"></i>
                                    {{ __('buttons.create') }}</a>
                            </div>
                        </div>
                    @endif
...
@section('script')
    ...
    <script>
        $('#cboProgram, #subAccountNumber, #agency, #no, #cboTodo, #cboStatus,#start_date,#end_date').on('change keyup',
            function() {
                $('#royaltyvoucher-table').DataTable().ajax.reload();
            });
    </script>
    ...
    <script>
        $('#btnExport').on('click', function(e) {
            ...
            let baseUrl = "{{ route('royaltyVoucher.exportRoyaltyVoucher', ['params' => $params]) }}";
