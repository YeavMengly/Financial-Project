            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="pristine-valid-example"
                        action="{{ route('budgetTraining.paymentDeadline.update', ['params' => $params, 'id' => $module->id]) }}"
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a class="btn btn-dark"
                                href="{{ route('budgetTraining.paymentDeadline.index', $params) }}">{{ __('buttons.back') }}</a>
...
@section('script')
    ...
    {{-- <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const EARLY_EP = "{{ route('budgetTraining.paymentDeadline.getEarlyBalance', ['params' => $params]) }}";
    ...
    {{-- <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const ENDPOINT = "{{ route('budgetTraining.paymentDeadline.editEarlyBalance', ['params' => $params]) }}";
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const ENDPOINT =
                "{{ route('budgetTraining.paymentDeadline.editEarlyBalance', ['params' => $params]) }}";
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleProgramChangeForProgramSub(programId, selectedId = null) {
                ...
                loadOptions({
                    url: "{{ route('budgetTraining.paymentDeadline.edit.program_sub') }}",
                    data: {
            ...
            function handleProgramChangeForAgency(programId, selectedId = null) {
                ...
                loadOptions({
                    url: "{{ route('budgetTraining.paymentDeadline.edit.agency') }}",
                    data: {
                        program_id: programId,
                        selected_id: selectedId
                    },
            ...
            function handleProgramSubChangeForCluster(programSubId, selectedId = null) {
                ...
                loadOptions({
                    url: "{{ route('budgetTraining.paymentDeadline.edit.cluster') }}",
                    data: {
    ...
    {{-- <script>
        ...
        $('#cboExpenseType').change(function() {
            ...
            $.ajax({
                url: '{!! route('budgetTraining.paymentDeadline.by.expense_type_id') !!}',
                type: 'get',
                data: {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadLegalId(expenseTypeId, selectedId = null) {
                ...
                $.ajax({
                    url: "{{ route('budgetTraining.paymentDeadline.edit.expense_type_id') }}",
                    type: "GET",
                    data: {
                        expense_type_id: expenseTypeId,
                        selected_id: selectedId
