...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('menus.payment.deadline') }}
                </h4>
                    ...
                    <form class="row gx-3 gy-2 align-items-center mb-4 mb-lg-0" id="filter" method="GET">
                        ...
                        <div class="col-sm-3 d-flex align-items-center gap-2">
                            ...
                            <a id="btnExport" href="{{ route(
                                'budgetTraining.paymentDeadline.export',
                                array_merge(
                                    ['params' => $params],
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @if (hasPermission('budgetTraining.paymentDeadline.create'))
                        <div class="col-sm">
                            <div class="mb-4">
                                <a class="btn btn-light waves-effect waves-light"
                                    href="{{ route('budgetTraining.paymentDeadline.create', $params) }}"><i class="bx bx-plus me-1"></i>
                                    {{ __('buttons.create') }}</a>
                            </div>
                        </div>
                    @endif
...
@section('script')
    ...
    <script>
     ...
     <script>
        $('#btnExport').on('click', function(e) {
            ...
            let baseUrl = "{{ route('budgetTraining.paymentDeadline.export', ['params' => $params]) }}";
    ...
    <script>
        $('#cboTodo, #cboStatus, #cboExpenseType, #cboAccountSub, #CboMandate').on('change keyup', function() {
            $('#budgetdeadlineTraining-table').DataTable().ajax.reload();
        });
    </script>
@endsection
