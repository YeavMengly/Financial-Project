    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18"> {{ __('menus.training') }}</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('menus.training') }}</a>
                        </li>
                ...
                <div class="card-body">
                    <div>
                        <form id="pristine-valid-example"
                            action="{{ route('budgetTraining.expenseRecord.store', $params) }}" method="POST"
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <a class="btn btn-dark"
                                    href="{{ route('budgetTraining.expenseRecord.index', $params) }}">{{ __('buttons.back') }}</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#cboProgram').on('change', function() {
                ...
                loadOptions({
                    url: "{{ route('budgetTraining.expenseRecord.by.program_sub') }}",
                    data: {
                ...
                loadOptions({
                    url: "{{ route('budgetTraining.expenseRecord.by.agency') }}",
                    data: {
                        program_id: programId
                    },
            ...
            $('#cboProgramSub').on('change', function() {
                ...
                loadOptions({
                    url: "{{ route('budgetTraining.expenseRecord.by.cluster') }}",
                    data: {
            ...
            const fetchEarlyBalance = async () => {
                ...
                const url = new URL(
                    "{{ route('budgetTraining.expenseRecord.getEarlyBalance', ['params' => $params]) }}",
