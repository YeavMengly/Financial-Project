...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            //     $.ajax({
            //         url: "{{ route('budgetMandate.get.expense_type_id') }}",
            //         type: 'GET',
            //         dataType: 'json',
            //         data: {
            ...
            //     loadDependentOptions("{{ route('budgetMandate.by.program_sub') }}", {
            //         program_id: programId
            //     }, '#cboProgramSub', programSubChoices, (inst) => programSubChoices = inst);
            //     loadDependentOptions("{{ route('budgetMandate.by.agency') }}", {
            //         program_id: programId
            ...
            //     loadDependentOptions("{{ route('budgetMandate.by.cluster') }}", {
            ...
            //     $.ajax({
            //         url: "{{ route('budgetMandate.getEarlyBalance', ['params' => $params]) }}",
            //         type: "GET",
            //         dataType: "json",
            //         data: {
            //             program_id: programId,
