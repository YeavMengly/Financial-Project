...
@section('content')
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a
                                href="javascript: void(0);">{{ __('menus.expenditure.procurement') }}</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form id="pristine-valid-example" action="{{ route('budgetProcurement.store', $params) }}"
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a class="btn btn-dark"
                                href="{{ route('budgetProcurement.index', $params) }}">{{ __('buttons.back') }}</a>
                        </div>
                    </form>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#cboProgram').on('change', function() {
                ...
                loadOptions({
                    url: "{{ route('budgetProcurement.by.program_sub') }}",
                    data: {
                ...
                loadOptions({
                    url: "{{ route('budgetProcurement.by.agency') }}",
                    data: {
                        program_id: programId
                    },
            ...
            $('#cboProgramSub').on('change', function() {
                ...
                loadOptions({
                    url: "{{ route('budgetProcurement.by.cluster') }}",
                    data: {
            ...
            const fetchEarlyBalance = async () => {
                ...
                const url = new URL(
                    "{{ route('budgetProcurement.getEarlyBalance', ['params' => $params]) }}", window
                    .location.origin);
            ...
            form.addEventListener('submit', function(e) {
                ...
                // Ensure skipped fields don't accidentally validate
