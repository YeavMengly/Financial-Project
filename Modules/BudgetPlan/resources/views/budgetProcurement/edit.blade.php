                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">
                                {{ __('menus.expenditure.procurement') }}</a></li>
                ...
                <div class="card-body">
                    <div>
                        <form id="pristine-valid-example"
                            action="{{ route('budgetProcurement.update', ['params' => $params, 'id' => $module->id]) }}"
...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const ENDPOINT = "{{ route('budgetProcurement.editEarlyBalance', ['params' => $params]) }}";
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleProgramChangeForProgramSub(programId, selectedId = null) {
                ...
                loadOptions({
                    url: "{{ route('budgetProcurement.edit.program_sub') }}",
                    data: {
            ...
            function handleProgramChangeForAgency(programId, selectedId = null) {
                ...
                loadOptions({
                    url: "{{ route('budgetProcurement.edit.agency') }}",
                    data: {
                        program_id: programId,
                        selected_id: selectedId
                    },
            ...
            function handleProgramSubChangeForCluster(programSubId, selectedId = null) {
                ...
                loadOptions({
                    url: "{{ route('budgetProcurement.edit.cluster') }}",
                    data: {
