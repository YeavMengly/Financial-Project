...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form id="pristine-valid-example" novalidate method="POST" action="{{ route('initialVoucher.store') }}"
                        autocomplete="off">
                        @csrf
                        <input type="hidden" />
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="cboYear" required tabindex="1">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            const element = document.getElementById('cboYear');
